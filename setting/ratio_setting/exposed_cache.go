...
func GetExposedData() gin.H {
	...
	newData := gin.H{
		...
		"upstream_model_ratio":      GetUpstreamModelRatioCopy(),
		"upstream_completion_ratio": GetUpstreamCompletionRatioCopy(),
		"upstream_cache_ratio":      GetUpstreamCacheRatioCopy(),
		"upstream_model_price":      GetUpstreamModelPriceCopy(),
	}
